...
export const SmallNavbar = () => {
  ...
  return (
    <div className="py-1 px-3 border-b-2 border-secondary bg-primary md2:hidden flex justify-between">
      <div>
        <svg
        ...
        {showMenu && (
          <div className="absolute top-7 left-3 bg-primary rounded-lg border-2 border-secondary">
            <div>
              <div className="px-6 py-2 cursor-pointer text-lg hover:bg-secondary hover:text-white focus:bg-secondary focus:text-white">
                Transactions
              </div>
              <div className="px-6 py-2 cursor-pointer text-lg hover:bg-secondary hover:text-white focus:bg-secondary focus:text-white">
                Personal
